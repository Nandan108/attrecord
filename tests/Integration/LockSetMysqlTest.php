...
/**
 * Real `SELECT … FOR UPDATE` locking via LockSet inside a transaction. MySQL/MariaDB only —
 * LockSet emits backtick-quoted SQL (it has no dialect handle), so it is not run on PostgreSQL.
 *
 * @group mysql
 */
