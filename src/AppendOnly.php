 ...
 * {@see Record::updateByWhere()}, {@see Record::deleteWhere()}, {@see RecordSet::saveAll()},
 ...
 *
 * {@see RecordSet::saveAll()} is rejected outright (not just when it would upsert): its insert-vs-upsert
